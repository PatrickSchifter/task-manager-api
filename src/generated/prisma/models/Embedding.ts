...
export type EmbeddingMinAggregateOutputType = {
  id: string | null
  sourceType: $Enums.EmbeddingSourceType | null
...
export type EmbeddingGroupByOutputType = {
  id: string
  sourceType: $Enums.EmbeddingSourceType
  sourceId: string
  content: string
...
export type EmbeddingWhereInput = {
  ...
  sourceType?: Prisma.EnumEmbeddingSourceTypeFilter<'Embedding'> | $Enums.EmbeddingSourceType
  sourceId?: Prisma.StringFilter<'Embedding'> | string
  content?: Prisma.StringFilter<'Embedding'> | string
  metadata?: Prisma.JsonFilter<'Embedding'>
  chunkIndex?: Prisma.IntFilter<'Embedding'> | number
...
export type EmbeddingWhereUniqueInput = Prisma.AtLeast<
  {
    id?: string
    sourceType_sourceId_chunkIndex?: Prisma.EmbeddingSourceTypeSourceIdChunkIndexCompoundUniqueInput
    AND?: Prisma.EmbeddingWhereInput | Prisma.EmbeddingWhereInput[]
    OR?: Prisma.EmbeddingWhereInput[]
    NOT?: Prisma.EmbeddingWhereInput | Prisma.EmbeddingWhereInput[]
    sourceType?: Prisma.EnumEmbeddingSourceTypeFilter<'Embedding'> | $Enums.EmbeddingSourceType
...
export type EmbeddingScalarWhereWithAggregatesInput = {
  ...
  sourceType?:
    | Prisma.EnumEmbeddingSourceTypeWithAggregatesFilter<'Embedding'>
    | $Enums.EmbeddingSourceType
  sourceId?: Prisma.StringWithAggregatesFilter<'Embedding'> | string
  content?: Prisma.StringWithAggregatesFilter<'Embedding'> | string
  metadata?: Prisma.JsonWithAggregatesFilter<'Embedding'>
  chunkIndex?: Prisma.IntWithAggregatesFilter<'Embedding'> | number
...
export type EmbeddingUpdateInput = {
  ...
  sourceType?: Prisma.EnumEmbeddingSourceTypeFieldUpdateOperationsInput | $Enums.EmbeddingSourceType
...
export type EmbeddingSourceTypeSourceIdChunkIndexCompoundUniqueInput = {
  sourceType: $Enums.EmbeddingSourceType
  sourceId: string
  chunkIndex: number
}
...
export type EnumEmbeddingSourceTypeFieldUpdateOperationsInput = {
  set?: $Enums.EmbeddingSourceType
}
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'sourceType' | 'sourceId' | 'content' | 'metadata' | 'chunkIndex' | 'createdAt',
  ExtArgs['result']['embedding']
>
...
export type EmbeddingGetPayload<S extends boolean | null | undefined | EmbeddingDefaultArgs> =
...
> {
  ...
  >(
    args: Prisma.SubsetIntersection<T, EmbeddingGroupByArgs, OrderByArg> & InputErrors,
  ): {} extends InputErrors ? GetEmbeddingGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
  /**
...
export interface EmbeddingFieldRefs {
  ...
  readonly sourceType: Prisma.FieldRef<'Embedding', 'EmbeddingSourceType'>
  readonly sourceId: Prisma.FieldRef<'Embedding', 'String'>
  readonly content: Prisma.FieldRef<'Embedding', 'String'>
  readonly metadata: Prisma.FieldRef<'Embedding', 'Json'>
  readonly chunkIndex: Prisma.FieldRef<'Embedding', 'Int'>
